...
public class RandomImage extends HttpServlet{
	...
	public void doPost(HttpServletRequest request, HttpServletResponse response)
			throws ServletException, IOException {
		String createTypeFlag = request.getParameter("createTypeFlag");//接受客户端传递的creatTypeFlag标识
		//1.在内存中创建一张图片
		...
		//String random = drawRandomNum((Graphics2D)g,"nl");//生成数字和字母组合验证码图片
		//String random = drawRandomNum((Graphics2D)g,"n");//生成纯数字验证码图片
		//String random = drawRandomNum((Graphics2D)g,"l");//生成纯字母验证码图片
